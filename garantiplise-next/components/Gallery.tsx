...
function Gallery() {
  ...
  return (
    <main className="py-16 bg-gradient-to-b from-gray-50 to-white relative">
          ...
          {images.map((image, index) => (
            ...
            >
              <Image
                ...
                alt={`Плисе комарница ${index + 1} - Garanti Plise`}
                width={400}
                height={256}
          ...
          >
            ...
            >
              ...
              <Image
                ...
                alt={`Плисе комарница ${currentIndex + 1} - Garanti Plise`}
                width={1200}
                height={800}
