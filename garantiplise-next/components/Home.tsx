    ...
    <main>
      ...
      <section className="relative pt-24 pb-20 md:pt-32 md:pb-28">
        <div className="absolute inset-0 overflow-hidden">
          <Image
            src="/images/home.png"
            alt="Плисе комарници и щори за вашия дом"
            fill
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-gray-50 rounded-xl overflow-hidden shadow-lg hover:shadow-xl transition-shadow relative group">
              <div className="h-[600px] overflow-hidden relative">
                <Image
                  src={windowImages[currentWindowImageIndex] || "/placeholder.svg"}
            ...
            <div className="bg-gray-50 rounded-xl overflow-hidden shadow-lg hover:shadow-xl transition-shadow relative group">
              <div className="h-[600px] overflow-hidden relative">
                <Image
                  src={doorImages[currentDoorImageIndex] || "/placeholder.svg"}
      ...
      <section className="py-16 md:py-24 bg-gradient-to-br from-pink-50 to-pink-100">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center mb-16">
            ...
            <p className="mt-4 text-xl text-gray-600">Комбинация от качество, изтънчен дизайн и доказана ефективност</p>
          </div>
          ...
          <div className="mt-16 max-w-3xl mx-auto bg-white p-8 rounded-xl shadow-lg">
            ...
            <p className="mt-4 text-gray-600 text-center">
              "Създаваме иновативни решения за защита от насекоми и контрол на светлината, които съчетават
              функционалност и естетика. Нашите плисе комарници и щори са проектирани да предлагат перфектен баланс
              между вентилация, естествена светлина и ефективна преграда против дразнещи насекоми, както и стилен дизайн
              за вашия дом."
            </p>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            potentialAction: {
              "@type": "SearchAction",
              target: "https://garantiplise.com/search?q={search_term_string}",
